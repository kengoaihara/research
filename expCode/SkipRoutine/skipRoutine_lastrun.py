...
expName = 'skipRoutine'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\ak221\\OneDrive\\デスクトップ\\skipRoutine_lastrun.py',
...
polygon = visual.ShapeStim(
    win=win, name='polygon', vertices=40,units='deg', 
    size=(10, 10),
    ori=0.0, pos=(0, 0),
