...
expName = 'sliderImage'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\SliderImage\\sliderImage_lastrun.py',
...
while continueRoutine:
    ...
    theseKeys = event.getKeys(keyList=['return', 'left', 'right'])
