...
lists = ["data1015b.csv", "data1018a.csv","data1019a.csv","data1020a.csv",
        "data1022b.csv","data1029a.csv","data1029c.csv", "data1031a.csv", "data1101a.csv"]
        
names = ["data1015b", "data1018a","data1019a","data1020a",
        "data1022b","data1029a","data1029c", "data1031a", "data1101a"]
...
for i in lists:
  ...
  #resp
  dat12 = dat11.replace('j', 0).replace('f', 1)
