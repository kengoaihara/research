...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\Main\\Size\\size.py',
...
welClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    # get current time
    t = welClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=welClock)
...
thisExp.addData('wel_pra.started', wel_pra.tStartRefresh)
thisExp.addData('wel_pra.stopped', wel_pra.tStopRefresh)
# check responses
...
thisExp.addData('resp_wel.started', resp_wel.tStartRefresh)
thisExp.addData('resp_wel.stopped', resp_wel.tStopRefresh)
thisExp.nextEntry()
...
for thisTrial_3 in trials_3:
    ...
    for thisComponent in praComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_3.addData('standard_pra.started', standard_pra.tStartRefresh)
    trials_3.addData('standard_pra.stopped', standard_pra.tStopRefresh)
    trials_3.addData('prove_pra.started', prove_pra.tStartRefresh)
    trials_3.addData('prove_pra.stopped', prove_pra.tStopRefresh)
    ...
    trials_3.addData('resp_pra.started', resp_pra.tStartRefresh)
    trials_3.addData('resp_pra.stopped', resp_pra.tStopRefresh)
...
for thisTrial_2 in trials_2:
    ...
    for thisTrial in trials:
        ...
        for thisComponent in trialComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        trials.addData('standard.started', standard.tStartRefresh)
        trials.addData('standard.stopped', standard.tStopRefresh)
